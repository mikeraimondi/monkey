...
const (
	_ int = iota
	// LOWEST is used for the initial call
	LOWEST
	// EQUALS is ==
	EQUALS
	// LESSGREATER is < or >
...
// Parser wraps a lexer and constructs an AST
type Parser struct {
	l      *lexer.Lexer
	errors []string
...
// ParseProgram constructs an AST
...
// Errors returns any errors the parser encountered during parsing
